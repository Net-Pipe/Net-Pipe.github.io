					...
					i.prototype.Q = function(e) {
							...
							var j = function(t, n, r) {
											...
											var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : `http://${t.get("link")}` : "",
													...
													f = I.hide ? "" : e.cfg.avatar ? `<img class="vimg alt" src="${e.cfg.avatar}" referrerPolicy="no-referrer"/>` : e.cfg.enableQQ && t.get("QQAvatar") ? `<img class="vimg alt" src="${t.get("QQAvatar")}" referrerPolicy="no-referrer"/>` : '<img class="vimg alt" src="' + (qq_img) + '">', /* (I.cdn + (0, s.default)(t.get("mail")) + I.params) */
													p = `\
${f}\
<div class="vh">\
