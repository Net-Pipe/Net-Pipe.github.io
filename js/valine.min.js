...
<div class="vpanel">\
	<div class="vwrap">\
		...
		<div class="vedit">\
			<textarea id="veditor" class="veditor vinput" placeholder="${e.cfg.placeholder}"></textarea>\
			<div class="vrow">\
					...
					i.prototype.Q = function(e) {
							...
							var j = function(t, n, r) {
											...
											var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : `http://${t.get("link")}` : "",
													...
													f = I.hide ? "" : e.cfg.avatar ? `<img class="vimg alt" src="${e.cfg.avatar}" referrerPolicy="no-referrer"/>` : e.cfg.enableQQ && t.get("QQAvatar") ? `<img class="vimg alt" src="${t.get("QQAvatar")}" referrerPolicy="no-referrer"/>` : '<img class="vimg alt" src="' + (I.cdn + (0, s.default)(t.get("mail")) + I.params) + '">',
													p = `\
${f}\
<div class="vh">\
