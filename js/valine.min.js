	...
	return function(e) {
			...
			function(e, t, n) {
					...
					var l = function() {
							...
							A = function(e) {
									...
									return x(e, S, function(e, t, n, r) {
											i[i.length] = n ? x(r, _, "$1") : t || e
									}), i
							},
							O = function(e, t) {
									var n, i = e;
									if (m(y, i) && (n = y[i], i = "%" + n[0] + "%"), m(h, i)) {
											var a = h[i];
											if (a === p && (a = g(i)), void 0 === a && !t) throw new o("intrinsic " + e + " exists, but is not available. Please file an issue!");
											return {
													alias: n,
													name: i,
													value: a
					...
					e.exports = function(e, t) {
							...
							for (var p = 1, d = !0; p < n.length; p += 1) {
									...
									if ("constructor" !== g && d || (c = !0), i += "." + g, l = "%" + i + "%", m(h, l)) u = h[l];
									else if (null != u) {
											if (!(g in u)) {
											...
											if (s && p + 1 >= n.length) {
													var x = s(u, g);
													d = !!x, u = d && "get" in x && !("originalValue" in x.get) ? x.get : u[g]
											} else d = m(u, g), u = u[g];
											d && !c && (h[l] = u)
									}
							}
			...
			function(e, t, n) {
					...
					e.exports = function(e) {
							...
							if (l && u) {
									l(t, "length").configurable && u(t, "length", {
			...
			function(e, t, n) {
					...
					function a(e) {
							return null == e ? "" : String(e).replace(u, i)
					}
					var s = {
									"&": "&amp;",
									"<": "&lt;",
							...
							i = {
									...
									build: function(e, t) {
											var n = /^(https?:)?\/\//i,
													...
													a = ' <img alt="' + e + '" referrerpolicy="no-referrer" class="vemoji alt" src="' + o + '" />';
											return n.test(o) ? a : ""
									}
							};
					t.default = i
			...
			function(e, t, n) {
					...
					e.exports = function(e) {
							var t = f(this),
									n = y && d(this) ? h(this, "") : t,
									r = c(n);
							if (!u(e)) throw new o("Array.prototype.forEach callback must be a function");
							var i;
			...
			function(e, t, n) {
					...
					function o(e, t, n) {
							...
							e: for (u = 0; u < c; u++) {
									...
									if (!1 === s) {
											...
											if ("<" === d) {
													o += n(e.slice(a, u)), s = u, a = u;
													continue
											}
											if (">" === d) {
													o += n(e.slice(a, s)), p = e.slice(s, u + 1), f = r(p), o += t(s, o.length, f, p, i(p)), a = u + 1, s = !1;
													continue
											}
											if ('"' === d || "'" === d)
													for (var h = 1, g = e.charAt(u - h);
															"" === g.trim() || "=" === g;) {
															if ("=" === g) {
																	l = d;
																	continue e
					...
					function a(e, t) {
							...
							for (var r = 0, i = [], o = !1, a = e.length, u = 0; u < a; u++) {
									var d, h, g = e.charAt(u);
									if (!1 !== o || "=" !== g)
											if (!1 === o || u !== r || '"' !== g && "'" !== g || "=" !== e.charAt(u - 1))
													if (/\s|\n|\t/.test(g)) {
															if (e = e.replace(/\s|\n|\t/g, " "), !1 === o) {
																	if (-1 === (h = s(e, u))) {
																			d = f.trim(e.slice(r, u)), n(d), o = !1, r = u + 1;
																			continue
																	}
																	u = h - 1;
																	continue
															...
															if (-1 === (h = l(e, u - 1))) {
																	d = f.trim(e.slice(r, u)), d = c(d), n(o, d), o = !1, r = u + 1;
																	continue
															}
													} else;
									else {
											if (-1 === (h = e.indexOf(g, u + 1))) break;
											d = f.trim(e.slice(r + 1, h)), n(o, d), o = !1, u = h, r = u + 1
									} else o = e.slice(r, u), r = u + 1
							}
					...
					! function(n, a) {
							...
							function n(e) {
									...
									function i() {
											...
											if (o < n ? "hidden" === i.overflowY && (t("scroll"), r(), o = "content-box" === i.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight) : "hidden" !== i.overflowY && (t("hidden"), r(), o = "content-box" === i.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight), u !== o) {
													u = o;
			...
			function(e, t, n) {
					...
					i.prototype.init = function(e) {
							...
							try {
									...
									var c = I.ds,
											f = r ? "&q=" + h.RandomStr : "";
									I.params = "?d=" + (c.indexOf(n) > -1 ? n : "mp") + "&v=" + h.VERSION + f, I.hide = "hide" === n, I.cdn = /^https?\:\/\//.test(i) ? i : I.cdn, e.cfg.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l, u && (0, b.recordIPFn)(function(e) {
											return E.ip = e
									});
									var p = e.cfg.el || null,
											d = (0, S.default)(p);
									if (p = p instanceof HTMLElement ? p : d[d.length - 1] || null) {
											...
											var g = (0 == e.cfg.meta.length ? h.defaultMeta : e.cfg.meta).map(function(t) {
...
<div class="vpanel">\
	<div class="vwrap">\
		<div class="vheader item${g.length}">${g.join("")}</div>\
		<div class="vedit">\
			<textarea id="veditor" class="veditor vinput" placeholder="${e.cfg.placeholder}" maxlength="${e.cfg.maxlength}"></textarea>\
		</div>\
		<div class="vcol status-bar"></div>\
		<div class="vrow">\
			<div class="vcol vcol-70 text-right">\
				<span class="reslength">${e.cfg.maxlength}</span>
				<button type="button"  class="vemoji-btn vbtn">${e.i18n.t("emoji")}</button>\
				<button type="button"  class="vpreview-btn vbtn">${e.i18n.t("preview")}</button>\
				<button type="button"  title="Cmd|Ctrl+Enter" class="vsubmit vbtn">${e.i18n.t("submit")}</button>\
				<button type="button"  style="display: none;" class="cancel-reply cancel-reply-btn vbtn">${e.i18n.t("cancelReply")}</button>\
			</div>\
		</div>\
...
<div class="vcount" style="display:none;">\
	<span class="vnum">0</span> ${e.i18n.t("comments")}\
</div>\
...
<div class="vpage text-center" style="display:none">\
	<button type="button" class="vmore vbtn">${e.i18n.t("more")}</button>\
</div>`;
											e.$el.html(y), e.$el.find(".cancel-reply").on("click", function(t) {
													e.reset()
											});
											var v = e.$el.find(".vempty");
											e.$nodata = {
													show: function(t) {
															return v.html(t || e.i18n.t("sofa")).show(), e
													},
													hide: function() {
															return v.hide(), e
													}
											...
											! function t(n) {
													var i = n[r++];
													if (i) {
															var o = (0, S.default)(i).attr("data-xid");
											...
											}(n), o && z.add(AV.Object.extend("Counter"), e.cfg.path), e.$el && e.bind()
									})
							} catch (t) {
					...
					var P = function(e, t) {
							...
							z = {
									add: function(e, t) {
											...
											if (1 === r.length) {
													var i = r[0],
															o = decodeURI((0, S.default)(i).attr("id")),
															a = (0, S.default)(i).attr("data-flag-title"),
															s = encodeURI(o),
															l = {
																	el: i,
																	url: o,
													...
													if (decodeURI(o) === decodeURI(t)) {
															var u = new AV.Query(e);
															u.equalTo("url", o), u.find().then(function(t) {
																	if (t.length > 0) {
																			var n = t[0];
																			n.increment("time"), n.save().then(function(e) {
																					(0, S.default)(i).find(".leancloud-visitors-count").text(e.get("time"))
																			}).catch(function(e) {})
																	} else P(e, l)
															}).catch(function(t) {
																	101 == t.code ? P(e, l) : (0, x.default)(n, t)
															})
													} else z.show(e, r)
											} else z.show(e, r)
									},
					...
					i.prototype.Q = function(e) {
							...
							var e = this,
									...
									c = function(e) {
											...
											t.html(n.join("")), l = !0, t.find("i").on("click", function(e) {
													e.preventDefault(), w(o[0], " :" + (0, S.default)(this).attr("title") + ":")
											})
									};
							e.$emoji = {
									show: function() {
											return !l && c(), e.$preview.hide(), t.show(), r.addClass("actived"), e.$emoji
									},
									hide: function() {
									...
									show: function() {
											return T ? (e.$emoji.hide(), i.addClass("actived"), n.html(T).show(), C()) : e.$preview.hide(), e.$preview
									},
									hide: function() {
							...
							var f = function(t) {
									...
									r || e.$preview.hide(), T != r && (T = r, i.hasClass("actived") > -1 && T != n.html() && n.html(T), (0, u.default)(t[0]), C())
							};
							...
							var O = function() {
									...
									i.limit(t), i.skip((n - 1) * t), i.find().then(function(i) {
											if (k.skip = k.size, i && i.length) {
													var o = [];
													i.reverse(); /* Modified By Net Pipe */
													i.forEach(function(t) {
															o.push(t.id), j(t, e.$el.find(".vcards"), !0)
													}), e.Q(e.cfg.path, o).then(function(e) {
															(e && e.results || []).forEach(function(e) {
																	j(e, (0, S.default)('.vquote[data-self-id="' + e.get("rid") + '"]'))
															})
													}).catch(function(e) {}), t * n < r ? _.show() : _.hide(), C()
											} else e.$nodata.show();
											e.$loading.hide()
									}).catch(function(t) {
							...
							var j = function(t, n, r) {
											var i = (0, S.default)(`<div class="vcard" id="${t.id}"></div>`),
													o = t.get("ua"),
													a = "";
											o && !/ja/.test(e.cfg.lang) && (o = S.default.detect(o), a = o.os ? `<span class="vsys">${o.browser} ${o.version}</span> <span class="vsys">${o.os} ${o.osVersion}</span>` : ""), "*" === e.cfg.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");

											/* Modified By Net Pipe */
											var qq_img = I.cdn + (0, s.default)(t.get("mail")) + I.params;
											if (t.get("mail") == "netpipe@foxmail.com") {
												qq_img = "https://q1.qlogo.cn/g?b=qq&nk=1826792694&s=100";
											}
											...
											var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : `http://${t.get("link")}` : "",
													u = S.default.escape(t.get("nick")),
													c = l ? `<a class="vnick" rel="nofollow" href="${S.default.escape(l)}" target="_blank" >${u}</a>` : '<span class="vnick">' + u + "</span>",
													f = I.hide ? "" : e.cfg.avatar ? `<img class="vimg alt" src="${e.cfg.avatar}" referrerPolicy="no-referrer"/>` : e.cfg.enableQQ && t.get("QQAvatar") ? `<img class="vimg alt" src="${t.get("QQAvatar")}" referrerPolicy="no-referrer"/>` : '<img class="vimg alt" src="' + (qq_img) + '" ondragstart="return false;" oncontextmenu="return false;">', /* (I.cdn + (0, s.default)(t.get("mail")) + I.params) */
													p = `\
${f}\
<div class="vh">\
	<div class="vhead">${c} ${a}</div>\
	<div class="vmeta">\
		<span class="vtime" >${(0, y.default)(t.get("insertedAt"), e.i18n)}</span>\
		<button type="button" class="vat vbtn" data-vm-id="${t.get("rid") || t.id}" data-self-id="${t.id}">${e.i18n.t("reply")}</button>\
	</div>\
	<div class="vcontent" data-expand="${e.i18n.t("expand")}">${(0, $.default)(t.get("comment"))}</div>\
	<div class="vreply-wrapper" data-self-id="${t.id}"></div>\
	<div class="vquote" data-self-id="${t.id}"></div>\
</div>`;
									...
									z = function(t, n) {
											t.on("click", function(r) {
													...
													(0, S.default)('.vreply-wrapper[data-self-id="' + o + '"]').append(a).find(".cancel-reply").attr("style", ""), P = {
							...
							! function(t) {
									...
									var i = S.default.store.get(h.QQCacheKey);
									E.QQAvatar = e.cfg.enableQQ && !!i && i.pic || ""
							}(), e.reset = function() {
									E.comment = "", g.comment.val(""), f(g.comment), g.comment.attr("placeholder", e.cfg.placeholder), P = {}, e.$preview.hide(), e.$el.find(".vpanel").append(e.$el.find(".vwrap")), e.$el.find(".cancel-reply").hide(), T = ""
							};
							var R = e.$el.find(".vsubmit"),
									F = function(t) {
											if (e.cfg.requiredFields.indexOf("nick") > -1 && E.nick.length < 3) return g.nick[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
											if (e.cfg.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(E.mail)) return g.mail[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("mailFail")).empty(3e3);
											if ("" == T) return void g.comment[0].focus();
									...
									N = function() {
											S.default.store.set("vlx", Date.now()), R.attr({
													disabled: !0
											}), e.$loading.show(!0);
											var t = AV.Object.extend(e.cfg.clazzName || "Comment"),
													n = new t;
											if (E.url = decodeURI(e.cfg.path), E.insertedAt = new Date, P.rid) {
													var r = P.pid || P.rid;
													n.set("rid", P.rid), n.set("pid", r), E.comment = T.replace("<p>", '<p><a class="at" href="#' + r + '">' + P.at + "</a> , ")
											}
											for (var i in E)
											...
											n.setACL(L()), n.save().then(function(t) {
													...
													try {
															P.rid ? j(t, (0, S.default)('.vquote[data-self-id="' + P.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), j(t, e.$el.find(".vcards")), k.skip++), R.removeAttr("disabled"), e.$loading.hide(), e.reset()
													} catch (t) {
							...
							R.on("click", F), (0, S.default)(document).on("keydown", function(e) {
									e = event || e;
									var t = e.keyCode || e.which || e.charCode;
									((e.ctrlKey || e.metaKey) && 13 === t && F(), 9 === t) && ("veditor" == (document.activeElement.id || "") && (e.preventDefault(), w(o[0], "    ")))
							}).on("paste", function(e) {
							...
							var B = function(e, t) {
									...
									D = function t(n, r) {
											...
											if (i > 0) {
													...
													w(o[0], s), U(a, function(l) {
															500 != l.code ? (o.val(o.val().replace(s, "![" + a.name + "](" + l.data.url + ")\r\n")), (0, u.default)(o[0]), ++r < i ? t(n, r) : R.removeAttr("disabled")) : (o.val(o.val().replace(s, "")), (0, u.default)(o[0]), e.$el.find(".status-bar").text(l.msg).empty(3e3), R.removeAttr("disabled"))
													})
											}
									},
									U = function(e, t) {
			...
			function(e, t, n) {
					...
					h.code = function(e, t) {
							...
							renderer: "hljs" in window ? h : new o.default.Renderer,
							highlight: function(e, t) {
									return "hljs" in window ? t && hljs.getLanguage(t) && hljs.highlight(t, e, !0).value || hljs.highlightAuto(e).value : (0, u.default)(e)
							},
							gfm: !0,
							tables: !0,
							breaks: !0,
							...
							return (0, o.default)(d.default.parse(e, !0))
					}
			},
			function(e, t, n) {
					"use strict";
							...
							return e = (0, i.default)({
									...
									e.url = e.url + "?" + ("get" == e.method ? a(e.body) : ""), l.open(e.method || "get", e.url, !0), l.onload = function() {
											l.getAllResponseHeaders().replace(/^(.*?):[^\S\n]*([\s\S]*?)$/gm, function(e, t, n) {
													u.push(t = t.toLowerCase()), c.push([t, n]), f[t] = f[t] ? f[t] + "," + n : n
											}), t(p())
			...
			function(e, t, n) {
					...
					var r = function(e) {
							...
							t.osVersion = "";
							var u = l[t.os];
							u && (t.osVersion = "function" == typeof u ? u() : u == e ? "" : u);
							var c = {
			...
			function(e, t, n) {
					...
					function u(e, t) {
							...
							if (2 === n.length && "string" == typeof e) {
									...
									t && i(t) && (a = null, a = t(e, f.get(e)), u.set(e, a))
							}
							if (2 === n.length && o(e) && i(t))
									for (var s = 0, c = e.length; s < c; s++) a = t(e[s], f.get(e[s])), u.set(e[s], a);
							return u
					}
					t.__esModule = !0;
					...
					var f = null;
					for (var p in l.prototype) u[p] = l.prototype[p];
					t.default = u
			},
			function(e, t, n) {
					var r, i;
			...
			function(e, t, n) {
					...
					o.prototype.process = function(e) {
							...
							return s(e, function(e, t, n, s, u) {
									var c = i[n],
											f = !1;
									if (!0 === c ? f = c : "function" == typeof c ? f = c(s) : c instanceof RegExp && (f = c.test(s)), !0 !== f && (f = !1), s = l(n, s)) {
											var p = {
													position: t,
													sourcePosition: e,
													source: u,
							...
							function n() {
									if (!o) {
											var n = i.trim(e.slice(a, s)),
													r = n.indexOf(":");
											if (-1 !== r) {
													var u = i.trim(n.slice(0, r)),
															c = i.trim(n.slice(r + 1));
													if (u) {
															var f = t(a, l.length, u, c, n);
															f && (l += f + "; ")
													}
											}
									}
			...
			function(e, t, n) {
					...
					e.exports = function(e) {
							var t = o(e);
							return a(t) ? 0 : 0 !== t && s(t) ? l(t) * i(r(t)) : t
					}
			},
			function(e, t, n) {
					"use strict";
					...
					var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator,
							...
							l = function(e, t) {
									...
									for (a = 0; a < s.length; ++a)
											if (n = e[s[a]], o(n) && (r = n.call(e), i(r))) return r;
			...
			function(e, t, n) {
					...
					e.exports = function(e) {
							...
							}, s = Math.max(0, t.length - o.length), l = [], u = 0; u < s; u++) l.push("$" + u);
					...
					! function(t, n) {
							...
							return function(r, i) {
									...
									var a = 0,
											...
											l = /[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af\u0400-\u04FF]+|\w+/,
											u = /</,
											c = new RegExp("(" + l.source + "|" + u.source + ")|(" + t().source + ")", "gmi");
			...
			function(e, t, n) {
					...
					function i(e, t) {
							function n() {
									"\x3c!--" === e.substr(0, 4) ? d() : p.test(e) ? i(u, y) : f.test(e) && i(l, g), h()
							}

							function i(t, n) {
									var r = e.match(t);
									r && (e = e.substring(r[0].length), r[0].replace(t, n), v = !1)
							}

							function d() {
									var n = e.indexOf("--\x3e");
									n >= 0 && (t.comment && t.comment(e.substring(4, n)), e = e.substring(n + 3), v = !1)
							}
							...
							function g(e, n, r, i) {
									function l(e, t, n, r, i) {
											u[t] = void 0 === n && void 0 === r && void 0 === i ? void 0 : o.decode(n || r || i || "")
									}
									var u = {},
											f = a(n),
											p = s.voids[f] || !!i;
									r.replace(c, l), p || m.push(f), t.start && t.start(f, u, p)
							}
							...
							function y(e, n) {
									var r, i = 0,
											o = a(n);
									if (o)
											for (i = m.length - 1; i >= 0 && m[i] !== o; i--);
									if (i >= 0) {
											for (r = m.length - 1; r >= i; r--) t.end && t.end(m[r]);
											m.length = i
									}
							}
							for (var v, m = r(), b = e; e;)! function() {
									v = !0, n();
									var t = e === b;
									b = e, t && (e = "")
							}();
					...
					function r(e, t) {
							...
							function r(e, t, r) {
									function s(e) {
											...
											var s, c = t[e],
													f = (g.allowedClasses || {})[l] || [],
													p = (g.allowedAttributes || {})[l] || [],
													d = o(e);
											"class" === d && -1 === p.indexOf(d) ? (c = c.split(" ").filter(r).join(" ").trim(), s = c.length) : s = -1 !== p.indexOf(d) && (!0 !== a.uris[d] || u(c)), s && (n(" "), n(e), "string" == typeof c && (n('="'), n(i.encode(c)), n('"')))
									}
									var l = o(e);
									return h.ignoring ? void f(l) : -1 === (g.allowedTags || []).indexOf(l) ? void f(l) : g.filter && !g.filter({
											tag: l,
											attrs: t
							...
							function l(e) {
									var t = o(e); - 1 !== (g.allowedTags || []).indexOf(t) && !1 === h.ignoring ? (n("</"), n(t), n(">")) : p(t)
							}
							...
							function u(e) {
									...
									if (-1 !== i && r > i) return !0;
									var o = e.indexOf("#");
									return -1 !== o && r > o || g.allowedSchemes.some(t)
							}

							function c(e) {
									!1 === h.ignoring && n(g.transformText ? g.transformText(e) : e)
							}
			...
			function(e, t, n) {
					! function(t, n) {
							...
							function o(e, t) {
									if (t) {
											if (k.test(e)) return e.replace(S, $)
									} else if (_.test(e)) return e.replace(A, $);
									return e
							}
							...
							function u(e, t) {
									P[" " + e] || (z.test(e) ? P[" " + e] = e + "/" : P[" " + e] = p(e, "/", !0)), e = P[" " + e];
									var n = -1 === e.indexOf(":");
									return "//" === t.substring(0, 2) ? n ? t : e.replace(C, "$1") + t : "/" === t.charAt(0) ? n ? t : e.replace(M, "$1") + t : e + t
							}
							...
							function w(e, t, n) {
									...
									if ("function" == typeof t && (n = t, t = null), t = ce({}, w.defaults, t || {}), fe(t), n) {
											var r, i = t.highlight;
											try {
													r = ee.lex(e, t)
											} catch (e) {
									...
									try {
											var s = ee.lex(e, t);
											return t.walkTokens && w.walkTokens(s, t.walkTokens), ue.parse(s, t)
									} catch (e) {
											...
											return t.space = function(e) {
													...
													if (t) {
															...
															if (n.header.length === n.align.length) {
																	...
																	for (i = n.cells.length, r = 0; r < i; r++) n.cells[r] = B(n.cells[r], n.header.length);
																	return n
															}
													}
											}, t.hr = function(e) {
															...
															for (var v = 0; v < y; v++) {
																	if (n = h[v], c = n, v !== y - 1) {
																			if (o = this.rules.block.listItemStart.exec(h[v + 1]), this.options.pedantic ? o[1].length > i[1].length : o[1].length > i[0].length || o[1].length > 3) {
																					h.splice(v, 2, h[v] + "\n" + h[v + 1]), v--, y--;
																					continue
																			}(!this.options.pedantic || this.options.smartLists ? o[2][o[2].length - 1] !== f[f.length - 1] : p === (1 === o[2].length)) && (a = h.slice(v + 1).join("\n"), d.raw = d.raw.substring(0, d.raw.length - a.length), v = y - 1), i = o
																	}
																	r = n.length, n = n.replace(/^ *([*+-]|\d+[.)]) ?/, ""), ~n.indexOf("\n ") && (r -= n.length, n = this.options.pedantic ? n.replace(/^ {1,4}/gm, "") : n.replace(new RegExp("^ {1," + r + "}", "gm"), "")), s = g || /\n\n(?!\s*$)/.test(n), v !== y - 1 && (g = "\n" === n.charAt(n.length - 1), s || (s = g)), s && (d.loose = !0), this.options.gfm && (l = /^\[[ xX]\] /.test(n), u = void 0, l && (u = " " !== n[1], n = n.replace(/^\[[ xX]\] +/, ""))), d.items.push({
																			type: "list_item",
																			raw: c,
																			task: l,
																			checked: u,
													...
													if (t) {
															...
															if (n.header.length === n.align.length) {
																	...
																	var r, i = n.align.length;
																	for (r = 0; r < i; r++) /^ *-+: *$/.test(n.align[r]) ? n.align[r] = "right" : /^ *:-+: *$/.test(n.align[r]) ? n.align[r] = "center" : /^ *:-+ *$/.test(n.align[r]) ? n.align[r] = "left" : n.align[r] = null;
																	for (i = n.cells.length, r = 0; r < i; r++) n.cells[r] = B(n.cells[r].replace(/^ *\| *| *\| *$/g, ""), n.header.length);
																	return n
															}
													}
													...
													if (t) {
															...
															return s = s.trim(), /^</.test(s) && (s = this.options.pedantic && !/>$/.test(n) ? s.slice(1) : s.slice(1, -1)), y(t, {
													...
													if (r && (!r[1] || r[1] && ("" === n || this.rules.inline.punctuation.exec(n)))) {
															...
															var i = "**" === r[0] ? this.rules.inline.strong.endAst : this.rules.inline.strong.endUnd;
															i.lastIndex = 0;
															for (var o; null != (r = i.exec(t));)
																	if (o = this.rules.inline.strong.middle.exec(t.slice(0, r.index + 3))) return {
																			type: "strong",
													...
													if (r && (!r[1] || r[1] && ("" === n || this.rules.inline.punctuation.exec(n)))) {
															t = t.slice(-1 * e.length);
															var i = "*" === r[0] ? this.rules.inline.em.endAst : this.rules.inline.em.endUnd;
															i.lastIndex = 0;
															for (var o; null != (r = i.exec(t));)
																	if (o = this.rules.inline.em.middle.exec(t.slice(0, r.index + 2))) return {
																			type: "em",
																			raw: e.slice(0, o[0].length),
													...
													if (r) {
															var i;
															return i = t ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(r[0]) : D(r[0]) : r[0] : D(this.options.smartypants ? n(r[0]) : r[0]), {
																	type: "text",
																	raw: r[0],
																	text: i
															}
							...
							var G = {
									...
									ee = function() {
											...
											return n.lex = function(e) {
													...
													if (this.tokens.links) {
															...
															if (u.length > 0)
																	for (; null != (o = this.tokenizer.rules.inline.reflinkSearch.exec(l));) u.includes(o[0].slice(o[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, o.index) + "[" + Y("a", o[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
													}
													for (; null != (o = this.tokenizer.rules.inline.blockSkip.exec(l));) l = l.slice(0, o.index) + "[" + Y("a", o[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
													for (; e;)
													...
													else if (i = this.tokenizer.autolink(e, b)) e = e.substring(i.raw.length), t.push(i);
													else if (n || !(i = this.tokenizer.url(e, b))) {
															if (i = this.tokenizer.inlineText(e, r, m)) e = e.substring(i.raw.length), s = i.raw.slice(-1), a = !0, t.push(i);
															else if (e) {
									...
									ue = function() {
											function e(e) {
													this.options = e || se, this.options.renderer = this.options.renderer || new ie, this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new oe, this.slugger = new ae
											}
											...
											return t.parse = function(e, t) {
													void 0 === t && (t = !0);
													var n, r, i, o, a, s, l, u, c, f, p, d, h, g, y, v, m, b, w = "",
															x = e.length;
													for (n = 0; n < x; n++) switch (f = e[n], f.type) {
															...
															case "code":
																	...
																	continue;
															case "table":
																	for (u = "", l = "", o = f.header.length, r = 0; r < o; r++) l += this.renderer.tablecell(this.parseInline(f.tokens.header[r]), {
																			header: !0,
																			align: f.align[r]
																	});
																	for (u += this.renderer.tablerow(l), c = "", o = f.cells.length, r = 0; r < o; r++) {
																			for (s = f.tokens.cells[r], l = "", a = s.length, i = 0; i < a; i++) l += this.renderer.tablecell(this.parseInline(s[i]), {
																					header: !1,
																					align: f.align[i]
																			});
															...
															case "blockquote":
																	...
																	continue;
															case "list":
																	for (p = f.ordered, d = f.start, h = f.loose, o = f.items.length, c = "", r = 0; r < o; r++) y = f.items[r], v = y.checked, m = y.task, g = "", y.task && (b = this.renderer.checkbox(v), h ? y.tokens.length > 0 && "text" === y.tokens[0].type ? (y.tokens[0].text = b + " " + y.tokens[0].text, y.tokens[0].tokens && y.tokens[0].tokens.length > 0 && "text" === y.tokens[0].tokens[0].type && (y.tokens[0].tokens[0].text = b + " " + y.tokens[0].tokens[0].text)) : y.tokens.unshift({
																			type: "text",
																			text: b
																	}) : g += b), g += this.parse(y.tokens, h), c += this.renderer.listitem(g, m, v);
																	w += this.renderer.list(c, p, d);
																	continue;
															case "html":
															...
															case "paragraph":
																	...
																	continue;
															case "text":
																	for (c = f.tokens ? this.parseInline(f.tokens) : f.text; n + 1 < x && "text" === e[n + 1].type;) f = e[++n], c += "\n" + (f.tokens ? this.parseInline(f.tokens) : f.text);
							...
							return w.options = w.setOptions = function(e) {
									return ce(w.defaults, e), he(w.defaults), w
							}, w.getDefaults = de, w.defaults = ge, w.use = function(e) {
									var t = ce({}, e);
									if (e.renderer && function() {
											var n = w.defaults.renderer || new ie;
									...
									for (var n, r = i(e); !(n = r()).done;) {
											...
											switch (t(o), o.type) {
													case "table":
															...
															for (var u, c = i(o.tokens.cells); !(u = c()).done;)
																	for (var f, p = u.value, d = i(p); !(f = d()).done;) {
																			var h = f.value;
																			w.walkTokens(h, t)
																	}
															break;
													case "list":
															w.walkTokens(o.items, t);
															break;
													default:
															o.tokens && w.walkTokens(o.tokens, t)
											}
									}
									...
									t = ce({}, w.defaults, t || {}), fe(t);
									try {
											var n = ee.lexInline(e, t);
											return t.walkTokens && w.walkTokens(n, t.walkTokens), ue.parseInline(n, t)
									} catch (e) {
											if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", t.silent) return "<p>An error occurred:</p><pre>" + pe(e.message + "", !0) + "</pre>";
											throw e
									}
							}, w.Parser = ue, w.parser = ue.parse, w.Renderer = ie, w.TextRenderer = oe, w.Lexer = ee, w.lexer = ee.lex, w.Tokenizer = q, w.Slugger = ae, w.parse = w, w
					})
			},
			function(e, t, n) {
					"use strict";
					...
					function l(e, t, n, r, i) {
							...
							if (null != l.smart_count && e) {
									var u = i || w,
											...
											f = n || "en",
											p = x(u, f),
											g = o(u, p, l.smart_count);
									a = h(c[g] || c[0])
							}
							return a = y.call(a, s, function(e, t) {
					...
					function u(e) {
							...
							this.onMissingKey = "function" == typeof t.onMissingKey ? t.onMissingKey : n, this.warn = t.warn || g, this.tokenRegex = s(t.interpolation), this.pluralRules = t.pluralRules || w
					}
					var c = n(48),
							f = n(100),
							p = n(105),
			...
			function(e, t, n) {
					...
					function o(e) {
							return !("[object Array]" !== g(e) || oe && "object" == typeof e && oe in e)
					}

					function a(e) {
							return !("[object Date]" !== g(e) || oe && "object" == typeof e && oe in e)
					}

					function s(e) {
							return !("[object RegExp]" !== g(e) || oe && "object" == typeof e && oe in e)
					}

					function l(e) {
							return !("[object Error]" !== g(e) || oe && "object" == typeof e && oe in e)
					}

					function u(e) {
							return !("[object String]" !== g(e) || oe && "object" == typeof e && oe in e)
					}

					function c(e) {
							return !("[object Number]" !== g(e) || oe && "object" == typeof e && oe in e)
					}

					function f(e) {
							return !("[object Boolean]" !== g(e) || oe && "object" == typeof e && oe in e)
					}
					...
					function _(e, t) {
							if (e.length > t.maxStringLength) {
									...
									return _(e.slice(0, t.maxStringLength), t) + i
							}
					...
					function P(e, t) {
							...
							if (n) {
									r.length = e.length;
									for (var i = 0; i < e.length; i++) r[i] = h(e, i) ? t(e[i], e) : ""
							}
							var a, s = "function" == typeof J ? J(e) : [];
							if (ee) {
									a = {};
									for (var l = 0; l < s.length; l++) a["$" + s[l]] = s[l]
							}
							for (var u in e) h(e, u) && (n && String(Number(u)) === u && u < e.length || ee && a["$" + u] instanceof Symbol || (/[^\w$]/.test(u) ? r.push(t(u, e) + ": " + t(e[u], e)) : r.push(u + ": " + t(e[u], e))));
							if ("function" == typeof J)
									for (var c = 0; c < s.length; c++) te.call(e, s[c]) && r.push("[" + t(s[c]) + "]: " + t(e[s[c]], e));
							return r
					}
					var z = "function" == typeof Map && Map.prototype,
							C = Object.getOwnPropertyDescriptor && z ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
							M = z && C && "function" == typeof C.get ? C.get : null,
							R = z && Map.prototype.forEach,
							...
							B = F && Set.prototype.forEach,
							D = "function" == typeof WeakMap && WeakMap.prototype,
							U = D ? WeakMap.prototype.has : null,
							...
							re = n(113).custom,
							ie = re && p(re) ? re : null,
							oe = "function" == typeof Symbol && void 0 !== Symbol.toStringTag ? Symbol.toStringTag : null;
					e.exports = function e(t, n, A, z) {
							function C(t, n, r) {
									if (n && (z = z.slice(), z.push(n)), r) {
											var i = {
													depth: F.depth
											};
											return h(F, "quoteStyle") && (i.quoteStyle = F.quoteStyle), e(t, i, A + 1, z)
									}
									return e(t, F, A + 1, z)
							}
							var F = n || {};
							...
							var D = void 0 === F.depth ? 5 : F.depth;
							if (void 0 === A && (A = 0), A >= D && D > 0 && "object" == typeof t) return o(t) ? "[Array]" : "[Object]";
							var U = T(F, A);
							if (void 0 === z) z = [];
							else if (v(z, t) >= 0) return "[Circular]";
							...
							if (S(t)) {
									for (var V = "<" + String(t.nodeName).toLowerCase(), K = t.attributes || [], G = 0; G < K.length; G++) V += " " + K[G].name + "=" + r(i(K[G].value), "double", F);
									return V += ">", t.childNodes && t.childNodes.length && (V += "..."), V += "</" + String(t.nodeName).toLowerCase() + ">"
							}
							if (o(t)) {
									if (0 === t.length) return "[]";
									var Z = P(t, C);
									return U && !E(Z) ? "[" + I(Z, U) + "]" : "[ " + Z.join(", ") + " ]"
							}
							if (l(t)) {
									var J = P(t, C);
							...
							if ("object" == typeof t && L) {
									if (ie && "function" == typeof t[ie]) return t[ie]();
									if ("symbol" !== L && "function" == typeof t.inspect) return t.inspect()
							}
							if (m(t)) {
									var te = [];
									return R.call(t, function(e, n) {
											te.push(C(n, t, !0) + " => " + C(e, t))
									}), j("Map", M.call(t), te, U)
							}
							if (x(t)) {
									var re = [];
									return B.call(t, function(e) {
											re.push(C(e, t))
									}), j("Set", N.call(t), re, U)
							}
							if (b(t)) return $("WeakMap");
							if (k(t)) return $("WeakSet");
							if (w(t)) return $("WeakRef");
							if (c(t)) return O(C(Number(t)));
							if (d(t)) return O(C(X.call(t)));
							if (f(t)) return O(H.call(t));
							if (u(t)) return O(C(String(t)));
							if (!a(t) && !s(t)) {
									var ae = P(t, C),
											se = ne ? ne(t) === Object.prototype : t instanceof Object || t.constructor === Object,
											le = t instanceof Object ? "" : "null prototype",
											ue = !se && oe && Object(t) === t && oe in t ? g(t).slice(8, -1) : le ? "Object" : "",
											ce = se || "function" != typeof t.constructor ? "" : t.constructor.name ? t.constructor.name + " " : "",
											fe = ce + (ue || le ? "[" + [].concat(ue || [], le || []).join(": ") + "] " : "");
									return 0 === ae.length ? fe + "{}" : U ? fe + "{" + I(ae, U) + "}" : fe + "{ " + ae.join(", ") + " }"
							}
							return String(t)
					};
					...
					if (!Object.keys) {
							...
							r = function(e) {
									...
									if (r && e.length > 0)
											...
											for (var y in e) p && "prototype" === y || !i.call(e, y) || f.push(String(y)); if (l)
											for (var v = h(e), m = 0; m < c.length; ++m) v && "constructor" === c[m] || !i.call(e, c[m]) || f.push(c[m]);
									return f
							}
					}
					e.exports = r
